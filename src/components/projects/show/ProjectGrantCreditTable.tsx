          ...
          <TableBody>
            {items?.map((item, index) => (
              <TableRow key={index} sx={{ height: "40px" }}>
                ...
                <StyledTableCell sx={{ width: "25%", textAlign: "center" }}>{item.totalSum}</StyledTableCell>
                <StyledTableCell sx={{ width: "25%", textAlign: "center" }}>{item.totalSumForeign}</StyledTableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
